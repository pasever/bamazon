...
checkers for vulnarebility 

State of your code:

- ESHint-standardjs 
   - var reassingmntres, leaks
   
- npm oudated 
- node securioty project
- snyk 
- retire.js

Safe coding 

HTTP Paremeter Pollution (HPP)
...
Regular expression slow down
- RXRR
- SDL RexEx Fuzzer 

Rate limit
Check against abuse of your APIs 
- koa-ratelimit

* drop connection using
* also hardware 


Performance helpers:
- flatter JSON 
- use cache for items that don't change or are repetitive 
- move static assets to nginx, webserver layer
